              ...
              <div className="col-lg-6 order-1 order-lg-1">
                <div className="content">
                  <div className="inner">
                    ...
                    <h1 className="title">ONLINE ALES Matematik Kursu</h1>
                    <p className="description has-medium-font-size mt--20">
                      Uzman eğitmenlerle hazırlanmış içerikler ve interaktif derslerle, ALES sınavında başarıya ulaşmanın anahtarı burada!
                    </p>
                    <div className="slider-btn rbt-button-group justify-content-start">
                      <a className="rbt-btn btn-gradient radius-round hover-icon-reverse" target="_blank" href="https://www.paytr.com/link/0bPrxow">
...
export default OnlineALESMatematikKursu;
