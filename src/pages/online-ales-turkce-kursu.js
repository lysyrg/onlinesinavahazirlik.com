              ...
              <div className="col-lg-6 order-1 order-lg-1">
                <div className="content">
                  <div className="inner">
                    ...
                    <h1 style={{ fontSize: '35px' }} className="title">ONLINE ALES Türkçe Kursu</h1>
                    ...
                    <div className="slider-btn rbt-button-group justify-content-start">
                      <a className="rbt-btn btn-gradient radius-round hover-icon-reverse" href="https://www.paytr.com/link/6jxx86X" target="_blank" rel="noopener noreferrer">
            ...
            <div className="col-lg-6">
              <div className="inner pl--50 pl_sm--5">
                <div className="content text-start">
                  <span className="rbt-badge-6 bg-primary-opacity">Online ALES Türkçe Kurs Kaydı</span>
                  <h2>Ödeme Seçenekleri</h2>
                  <ul>
                    <li><strong>Kredi Kartı ile Ödeme:</strong></li>
                    <ul>
                      <li><strong>Online KPSS Türkçe Kurs Ödeme Linki:</strong> <a href="https://www.paytr.com/link/6jxx86X" target="_blank" rel="noopener noreferrer">Ödeme Yap</a></li>
                    </ul>
...
export default OnlineALESTurkceKursu;
