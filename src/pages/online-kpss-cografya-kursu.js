              ...
              <div className="col-lg-6 order-1 order-lg-1">
                <div className="content">
                  <div className="inner">
                    ...
                    <h1 style={{ fontSize: '35px' }} className="title">ONLINE KPSS Coğrafya Kursu</h1>
                    ...
                    <div className="slider-btn rbt-button-group justify-content-start">
                      <a className="rbt-btn btn-gradient radius-round hover-icon-reverse" target="_blank" rel="noopener noreferrer" href="https://www.paytr.com/link/CCVxaxl">
              ...
              <div className="col-lg-6">
                <div className="inner pl--50 pl_sm--5">
                  <div className="content text-start">
                    <span className="rbt-badge-6 bg-primary-opacity">Online KPSS Coğrafya Kurs Kaydı</span>
                    <h2>Ödeme Seçenekleri</h2>
                    <ul>
                      <li><strong>Kredi Kartı ile Ödeme:</strong></li>
                      <ul>
                        <li><strong>Online KPSS Coğrafya Kurs Ödeme Linki:</strong> <a href="https://www.paytr.com/link/CCVxaxl" target="_blank" rel="noopener noreferrer">Ödeme Yap</a></li>
                      </ul>
...
export default OnlineKPSSCografyaKursu;
