              ...
              <div className="col-lg-6 order-1 order-lg-1">
                <div className="content">
                  <div className="inner">
                    ...
                    <h1 style={{ fontSize: '35px' }} className="title">ONLINE KPSS Vatandaşlık Kursu</h1>
                    <p className="description has-medium-font-size mt--20">
                      Uzman eğitmenlerle hazırlanmış içerikler ve interaktif derslerle, KPSS sınavında başarıya ulaşmanın anahtarı burada!
                    </p>
                    <div className="slider-btn rbt-button-group justify-content-start">
                      <a className="rbt-btn btn-gradient radius-round hover-icon-reverse" target="_blank" rel="noopener noreferrer" href="https://www.paytr.com/link/ZjlKd5B">
        ...
        <div className="row">
          ...
          <div className="col-lg-6 col-md-6">
            <div className="video-wrapper">
              <h4>Örnek Vatandaşlık Ders Videosu</h4>
              <iframe width="100%" height="315" src="https://www.youtube.com/embed/oUjH8mDdLpA" frameBorder="0" allowFullScreen></iframe>
            </div>
          </div>
        </div>
      </div>
            ...
            <div className="row g-5">
              <div className="col-lg-6">
                ...
                <ul className="rbt-list-style-1">
                  <li><i className="feather-check"></i>📚 Toplam 36 saat ONLINE (CANLI DERS)</li>
              ...
              <div className="col-lg-6" data-sal="slide-up" data-sal-duration="700">
                <div className="inner pl--50 pl_sm--5">
                  <div className="content text-start">
                    <span className="rbt-badge-6 bg-primary-opacity">Online KPSS Vatandaşlık Kurs Kaydı</span>
                    <h2>Ödeme Seçenekleri</h2>
                    <ul>
                      <li><strong>Kredi Kartı ile Ödeme:</strong></li>
                      <ul>
                        <li><strong>Online KPSS Vatandaşlık Kurs Ödeme Linki:</strong> <a href="https://www.paytr.com/link/SGKe7o9">Ödeme Yap</a></li>
                      </ul>
                    ...
                    <div className="row">
                      ...
                      <p><strong>4. WhatsApp Grubu ve Canlı Ders Linkleri:</strong> Kurs kaydınızın tamamlanmasının ardından sizi WhatsApp grubumuza ekleyeceğiz. Canlı ders giriş linkleri ve diğer önemli duyurular bu grup üzerinden paylaşılacaktır. Bu sayede dersleri kaçırmadan takip edebilirsiniz.</p>
                    </div>
                  </div>
                </div>
              </div>
...
export default OnlineKPSSTurkiyeKursu;
