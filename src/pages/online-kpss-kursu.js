    ...
    <div className="rbt-header-sticky">
              ...
              <div className="col-lg-6 order-1 order-lg-1">
                <div className="content">
                  <div className="inner">
                    ...
                    <h1 className="title">KPSS Kursu</h1>
      ...
      <div className="container mt--50">
        <div className="row">
          ...
          <div className="col-lg-6 col-md-6">
            <div className="video-wrapper">
              <h4>Örnek Tarih Ders Videosu</h4>
              <iframe width="100%" height="315" src="https://www.youtube.com/embed/tlZ9bxygjT0" frameBorder="0" allowFullScreen></iframe>
            </div>
          </div>
        </div>
        ...
        <div className="row mt--30">
          <div className="col-lg-12">
            <div className="video-wrapper">
              <h4>Örnek Coğrafya Ders Videosu</h4>
              <iframe width="100%" height="315" src="https://www.youtube.com/embed/YP4Apbwyaqw" frameBorder="0" allowFullScreen></iframe>
            </div>
          </div>
        </div>
      </div>
            ...
            <div className="row g-5">
              <div className="col-lg-6">
                ...
                <ul className="rbt-list-style-1">
                  ...
                  <li><i className="feather-check"></i>👍Matematik: 80 Saat </li>
                  <li><i className="feather-check"></i>👍Geometri: 20 Saat </li>
                  <li><i className="feather-check"></i>👍Sayısal, Sözel Mantık: 16 Saat </li>
                  <li><i className="feather-check"></i>👍Türkçe: 32 Saat </li>
                  <li><i className="feather-check"></i>👍Tarih: 76 Saat </li>
                  <li><i className="feather-check"></i>👍Coğrafya: 36 Saat</li>
                  <li><i className="feather-check"></i>👍Vatandaşlık: 40 Saat </li>
                  <li><i className="feather-check"></i>👍Genel Tekrar ve Soru Çözümü: 100 Saat</li>
                </ul>
              </div>
              <div className="col-lg-6">
                <div className="section-title">
...
export default OnlineKPSSKursu;
