              ...
              <div className="col-lg-6 order-1 order-lg-1">
                <div className="content">
                  <div className="inner">
                    ...
                    <h1 style={{ fontSize: '35px' }} className="title">ONLINE KPSS Tarih Kursu</h1>
                    ...
                    <div className="slider-btn rbt-button-group justify-content-start">
                      <a className="rbt-btn btn-gradient radius-round hover-icon-reverse" target="_blank" rel="noopener noreferrer" href="https://www.paytr.com/link/atRKX0M">
            ...
            <div className="row g-5">
              <div className="col-lg-6">
                ...
                <ul className="rbt-list-style-1">
                  <li><i className="feather-check"></i>📚 Toplam 100 saat ONLINE (CANLI DERS)</li>
              ...
              <div className="col-lg-6" data-sal="slide-up" data-sal-duration="700">
                <div className="inner pl--50 pl_sm--5">
                  <div className="content text-start">
                    <span className="rbt-badge-6 bg-primary-opacity">Online KPSS Tarih Kurs Kaydı</span>
                    <h2>Ödeme Seçenekleri</h2>
                    <ul>
                      <li><strong>Kredi Kartı ile Ödeme:</strong></li>
                      <ul>
                        <li><strong>Online KPSS Tarih Kurs Ödeme Linki:</strong> <a href="https://www.paytr.com/link/atRKX0M">Ödeme Yap</a></li>
                      </ul>
...
export default OnlineKPSSTarihKursu;
