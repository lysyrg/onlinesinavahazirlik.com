              ...
              <div className="col-lg-6 order-1 order-lg-1">
                <div className="content">
                  <div className="inner">
                    ...
                    <h1 style={{ fontSize: '35px' }} className="title">ONLINE DGS Matematik Kursu</h1>
                    ...
                    <div className="slider-btn rbt-button-group justify-content-start">
                      <a className="rbt-btn btn-gradient radius-round hover-icon-reverse" target="_blank" rel="noopener noreferrer" href="https://www.paytr.com/link/19ARFor">
              ...
              <div className="inner pl--50 pl_sm--5">
                <div className="content text-start">
                  ...
                  <ul>
                    ...
                    <ul>
                      <li><strong>Online KPSS Matematik Kurs Ödeme Linki:</strong> <a href="https://www.paytr.com/link/19ARFor" target="_blank" rel="noopener noreferrer">Ödeme Yap</a></li>
                    </ul>
...
export default OnlineDGSMatematikKursu;
